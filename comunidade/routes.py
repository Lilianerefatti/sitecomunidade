...
def salvar_imagem(imagem):
    codigo = secrets.token_hex(8)  # adicionar um código aleatório no nome da imagem
    nome, extensao = os.path.splitext(imagem.filename)
    nome_arquivo = nome + codigo + extensao
    caminho_completo = os. path.join (app.root_path, 'static/fotos_perfil', nome_arquivo ) # salvar a imagem na pasta fotos_perfil
